...
public class Controller {
	...
	void updateUI(EditText ignore) {
		...
		if (calc.firstInput == IO.SPEED || calc.secondInput == IO.SPEED) {
			((TextView) view.findViewById(R.id.ioSpeedLabel)).setText(R.string.inputText);
		...
		if (calc.firstInput == IO.DISTANCE || calc.secondInput == IO.DISTANCE) {
			((TextView) view.findViewById(R.id.ioDistanceLabel)).setText(R.string.inputText);
		...
		if (calc.firstInput == IO.TIME || calc.secondInput == IO.TIME) {
			((TextView) view.findViewById(R.id.ioTimeLabel)).setText(R.string.inputText);
			((TextView) view.findViewById(R.id.timeLabel)).setTextAppearance(view, R.style.InputLabel);
		}
		// now the outputs
		if (calc.output == IO.SPEED) {
			((TextView) view.findViewById(R.id.ioSpeedLabel)).setText(R.string.outputText);
			...
			((TextView) view.findViewById(R.id.ioDistanceLabel)).setText(R.string.outputText);
			((TextView) view.findViewById(R.id.distanceLabel)).setTextAppearance(view, R.style.OutputLabel);
		} else if (calc.output == IO.TIME) {
			((TextView) view.findViewById(R.id.ioTimeLabel)).setText(R.string.outputText);
